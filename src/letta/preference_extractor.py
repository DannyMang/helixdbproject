"""
Preference Extractor for Toph Bot - Handles parsing user preferences from various formats
"""
...
class PreferenceExtractor:
    ...
    def extract_preference_content_from_comment(self, comment_body: str) -> str:
        ...
        setup_patterns = ["@toph-bot setup", "@toph-bot setup"]
